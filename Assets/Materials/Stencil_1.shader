Shader "Custom/Stencil_1"
{
    Properties
    {
        ...
        [Enum(UnityEngine.Rendering.CompareFunction)]_CompFront("CompFront",Float) = 6
        [Enum(UnityEngine.Rendering.CompareFunction)]_CompBack("CompBack",Float) = 6
        ...
        _StencilRefDepth("StencilRefDepth", Int) = 8
    ...
    SubShader
    {
        ...
        {
            SurfaceDescription surface = (SurfaceDescription)0;
            surface.BaseColor = float3(_BaseColor.r,_BaseColor.g,_BaseColor.b);//IsGammaSpace() ? float3(0.5, 0.5, 0.5) : SRGBToLinear(float3(0.5, 0.5, 0.5));
        ...
        void BuildSurfaceData(FragInputs fragInputs, inout SurfaceDescription surfaceDescription, float3 V, PositionInputs posInput, out SurfaceData surfaceData, out float3 bentNormalWS)
        {
            ...
            surfaceData.baseColor =                 _BaseColor;//surfaceDescription.BaseColor;
        ...
        void BuildSurfaceData(FragInputs fragInputs, inout SurfaceDescription surfaceDescription, float3 V, PositionInputs posInput, out SurfaceData surfaceData, out float3 bentNormalWS)
        {
            ...
            surfaceData.baseColor =                 float3(_BaseColor.r,_BaseColor.g,_BaseColor.b);//surfaceDescription.BaseColor;
            surfaceData.perceptualSmoothness =      surfaceDescription.Smoothness;
            surfaceData.ambientOcclusion =          surfaceDescription.Occlusion;
            surfaceData.metallic =                  surfaceDescription.Metallic;
